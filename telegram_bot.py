...
def start_command(update, context):
    ...
    update.message.reply_text("Hi I'm the brother of Aikins @gladaikins, Just start texting me. Append \"@gif\" for me to generate a GIF. If I'm getting annoying, type \"Bye\"")
